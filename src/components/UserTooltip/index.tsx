          ...
          >
            { user? 
              <>
                ...
                {user.admin && <button type='button' onClick={() => history.push('/register')}>Cadastrar Usuário</button>}
                {user.admin && <button type='button' onClick={() => history.push('/createDistrict')}>Cadastrar Bairro</button>}
